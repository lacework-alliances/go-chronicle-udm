...
type Authentication struct {
	AuthType             string `json:"authType,omitempty"`             // Type of system an authentication event is associated. Enumerated
	AuthenticationStatus string `json:"authenticationStatus,omitempty"` // Status of user or credential. Enumerated
