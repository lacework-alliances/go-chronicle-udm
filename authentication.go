...
type Authentication struct {
	AuthType             string `json:"auth_type,omitempty"`             // Type of system an authentication event is associated. Enumerated
	AuthenticationStatus string `json:"authentication_status,omitempty"` // Status of user or credential. Enumerated
