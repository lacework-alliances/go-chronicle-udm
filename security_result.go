...
type SecurityResult struct {
	...
	ActionDetails     string `json:"action_details,omitempty"`     // Vendor-provided details of the action taken as a result of the security incident. Examples: drop, block, decrypt, encrypt
	Category          string `json:"category,omitempty"`           // Enumerated
	Confidence        string `json:"confidence,omitempty"`         // Enumerated
	ConfidenceDetails string `json:"confidence_details,omitempty"` // Additional detail with regards to the confidence of a security event as estimated by the product vendor.
	Priority          string `json:"priority,omitempty"`           // Enumerated
	RuleID            string `json:"rule_id,omitempty"`
	RuleName          string `json:"rule_name,omitempty"`
	Severity          string `json:"severity,omitempty"`         // Enumerated
	SeverityDetails   string `json:"severity_details,omitempty"` // Severity for a security event as estimated by the product vendor.
